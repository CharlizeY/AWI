...
None
>>> soup.find("div", {"data-react-class": "common/GoToPage"})
<div data-react-class="common/GoToPage" data-react-props='{"maxPage":1754,"pageParam":"p"}'></div>
...
'<div data-react-class="common/GoToPage" data-react-props=\'{"maxPage":1754,"pageParam":"p"}\'></div>'
>>> exit()
Joys-MBP:~ JoyCowper$ cd Desktop
Joys-MBP:Desktop JoyCowper$ python3 TestArtPrice.py
1753
Joys-MBP:Desktop JoyCowper$ python3 TestArtPrice.py
1753
Joys-MBP:Desktop JoyCowper$ python3 TestArtPrice.py
...
Joys-MBP:Desktop JoyCowper$ python3 TestArtPrice.py
1754
Joys-MBP:Desktop JoyCowper$ python
Python 3.6.5 |Anaconda, Inc.| (default, Apr 26 2018, 08:42:37)
[GCC 4.2.1 Compatible Clang 4.0.1 (tags/RELEASE_401/final)] on darwin
Type "help", "copyright", "credits" or "license" for more information.
>>> import requests
>>> requests.get('https://www.artprice.com/marketplace/1500396/johann-heinrich-bleuler/drawing-watercolor/aussicht-von-vevey-uber-den-genfer-see')
<Response [200]>
>>> Req = requests.get('https://www.artprice.com/marketplace/1500396/johann-heinrich-bleuler/drawing-watercolor/aussicht-von-vevey-uber-den-genfer-see')
>>> Req.history
...
<Response [301]>
<Response [302]>
>>> for i in range(1, len(str(Hist[0])):
  File "<stdin>", line 1
    for i in range(1, len(str(Hist[0])):
                                       ^
SyntaxError: invalid syntax
...
Traceback (most recent call last):
  File "<stdin>", line 1, in <module>
NameError: name 'HistString' is not defined
>>> for i in HistStr:
...     try:
...             int(i)
...     except:
